...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(FavoritesUsersListViewModel::class)
    abstract fun bindFavoritesUserViewModel(favoritesUsersListViewModel: FavoritesUsersListViewModel): ViewModel
